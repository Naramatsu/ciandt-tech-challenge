...
const Overview = () => {
  const { pokemon, getPokemonInformation } = useContext(AppContext);
  ...
  }, [pokemon, pokemonName, getPokemonInformation]);
        ...
        <section className="info__group">
          <section>
            <section className="info__group groups">
              <img
                src={
                  pokemonOveriew?.sprites?.other[officialArtWork].front_default
                }
                alt="pokemon preview"
              />
              <section>
